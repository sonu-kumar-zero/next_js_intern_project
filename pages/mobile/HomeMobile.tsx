        ...
        <>
            <div className="block md:hidden h-[100dvh]">
                <div className="flex h-fit text-sm w-full items-center justify-around pb-2">
                    <div className="px-5 py-2 bg-gray-300 text-red-400 font-bold w-full border" onClick={() => SetIsDiscussionForm(true)}>DISSCUSSION FOURM</div>
                    <div className="px-5 py-2 bg-gray-300 text-red-400 font-bold w-full border" onClick={() => SetIsDiscussionForm(false)}>MARKET STORIES</div>
                </div>
